...
@Route(value = AddFloorView.ROUTE, layout = MainView.class)
@PageTitle("Add a new floor")
@CssImport("./styles/views/floor/add-floor-view.css")
@Secured(AddFloorView.PRIVILEGE)
public class AddFloorView extends VerticalLayout {
    ...
    public AddFloorView(FloorRepository floorRepository, NoticeBoardRepository noticeBoardRepository) {
